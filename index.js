    ...
    function SendMailBody(bodyObj) {
        ...
        const msg = {
            ...
            html: '<div style="display: inline-block; text-align:center;padding:1rem;border:5px solid gray;"><div style="display:flex;justify-content: space-between;"><span style="font-size: 2em;border-bottom: 2px solid #e91e6385;display: inline-table;">' + bodyObj.value1 + (bodyObj.value1 ? "<span style='margin-left:.5em'>USD </span>" : "") +
                ...
                bodyObj.eth + '</div><img src=' + img_different_width + '><div ><span style="font-size:13px; margin-top: -30px;">This QR code can be scanned to get the address</span></div></div>',
        };
        sgMail.send(msg);
